...
1. Programı çalıştırdığınızda, bir ana menü karşınıza çıkar.
2. Ana menüde, farklı işlemler için numaralandırılmış seçenekler görüntülenir.
3. İstenilen işlem için ilgili numarayı girin.
4. Notebook veya cep telefonu eklemek, listelemek veya silmek için uygun seçenekleri seçin.
5. İşlemleri tamamladıktan sonra, ana menüden "0" seçeneğini seçerek çıkış yapabilirsiniz.

## Özellikler

- Notebook ve cep telefonu eklemek için ayrı ayrı işlemler bulunmaktadır.
- Eklenen ürünlerin özellikleri (ID, tür, marka, renk, fiyat, indirim oranı, stok, hafıza, ekran boyutu, batarya, RAM) kullanıcıdan alınır.
- Eklenen ürünler, ilgili marka listesine otomatik olarak eklenir.
- Eklenen ürünler ve markalar, kullanıcı tarafından listelenebilir.
- Kullanıcı, istediği ürünü ve markayı silme yetkisine sahiptir.
